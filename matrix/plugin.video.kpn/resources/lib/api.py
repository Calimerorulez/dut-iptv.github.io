...
class API(object):
    ...
    def get_channel_data(self, row):
        ...
        path = ADDON_PROFILE + "images" + os.sep + str(row['metadata']['channelId']) + ".png"
    ...
    def vod_seasons(self, id):
        ...
        if settings.getBool(key='enable_cache') == True and is_file_older_than_x_minutes(file=ADDON_PROFILE + file, minutes=10) == False:
            ...
            if data and check_key(data['resultObj'], 'containers') and settings.getBool(key='enable_cache') == True:
    ...
    def vod_season(self, id):
        ...
        file = "cache" + os.sep + "vod_season_" + str(id) + ".json"
